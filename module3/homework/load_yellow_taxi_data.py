...
# First, create a bucket in Google Cloud Storage
BUCKET_NAME = "khai-bucket"

# If you authenticated through the GCP SDK you can comment out these two lines
CREDENTIALS_FILE = "D:/zoomcamp/module1/1_terraform_gcp/terrademo/basic/keys/my-creds.json"
